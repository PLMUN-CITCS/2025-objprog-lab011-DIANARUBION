...
public class NumberClassifierMenu {
    public static void main(String[] args) {
        ...
        // Start the do-while loop to allow repeated menu display
        do {
            ...
            int choice = input.nextInt(); // Read user menu choice
            ...
            switch (choice) {
                case 1:
                    ...
                    // Demonstrate additional boolean expression: check if the number is even or odd
                    if (number % 2 == 0) {
        ...
        } while (userChoice == 'Y'); // Condition to continue the loop
